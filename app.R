...
ui <- fluidPage(
  ...
  fluidRow(
    ...
    column(4,
      ...
      HTML(paste("<p>Since the first dataset was posted on April 2nd, 2018, there are now nearly",
                 "80 datasets and 2,672 #TidyTuesday tweets from 614 users! Use the options",
