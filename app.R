...
ui <- fluidPage(
  ...
  fluidRow(
    ...
    column(4,
      ...
      HTML(paste("<p>tidytuesday.rocks is built with <a href='https://shiny.rstudio.com/'>Shiny</a> and ",
                 "<a href='https://rtweet.info/'>rtweet</a>",
                 "and its source code is <a href='https://github.com/nsgrantham/tidytuesdayrocks'>",
                 "on GitHub</a>. The app is only about 100 lines of R code and requires manual labelling ", 
                 "of tweets (which I make time for once every two weeks).</p>")),
      HTML(paste("<p>The response to tidytuesday.rocks has been amazing! And it was recently announced to be", 
                 "<a href='https://blog.rstudio.com/2019/04/05/first-shiny-contest-winners/'>a runner up in the 1st Shiny Contest</a>",
